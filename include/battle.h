...
#define MOVE_STATUS_FLAG_CRITICAL           (1 << 4)    // 0000 0000 0000 0000 0000 0000 0001 0000
...
#define MOVE_STATUS_FLAG_PP_NONE            (1 << 9)    // 0000 0000 0000 0000 0000 0010 0000 0000
...
#define MOVE_STATUS_FLAG_SPLASH             (1 << 13)   // 0000 0000 0000 0000 0010 0000 0000 0000
...
#define MOVE_STATUS_FLAG_SEMI_INVULNERABLE  (1 << 16)   // 0000 0000 0000 0001 0000 0000 0000 0000
#define MOVE_STATUS_FLAG_LOST_FOCUS         (1 << 17)   // 0000 0000 0000 0010 0000 0000 0000 0000
...
#define MOVE_STATUS_FLAG_NO_MORE_WORK       (1 << 31)   // 1000 0000 0000 0000 0000 0000 0000 0000

#define MOVE_STATUS_FLAG_NOHIT_OFF      (MOVE_STATUS_FLAG_MISS^0xffffffff)
...
#define MOVE_STATUS_FLAG_FAILURE_ANY    (MOVE_STATUS_FLAG_MISS|MOVE_STATUS_FLAG_NOT_EFFECTIVE|\
                                         ...
                                         MOVE_STATUS_FLAG_SEMI_INVULNERABLE|\
...
#define WAZA_STATUS_FLAG_NO_OUT         (MOVE_STATUS_FLAG_FAILURE_ANY|\
                                         MOVE_STATUS_FLAG_PP_NONE|\
                                         MOVE_STATUS_FLAG_NO_MORE_WORK)
...
/**
 *  @brief battle status flags (for BattleStruct's u32 server_status_flag)
...
/**
 *  @brief battle status 2 flags (for BattleStruct's u32 server_status_flag2)
        ...
        if (ctx->clientLoopForSpreadMoves <= SPREAD_MOVE_LOOP_MAX) {\
            ...
            if (IS_VALID_MOVE_TARGET(ctx, ctx->defence_client)) {\
                ...
                if (failureSubscriptToRun > 1) {\
                    ...
                    ctx->next_server_seq_no = ctx->server_seq_no;\
                    ctx->server_seq_no = CONTROLLER_COMMAND_RUN_SCRIPT;\
                    ctx->moveStatusFlagForSpreadMoves[ctx->defence_client] = MOVE_STATUS_FLAG_NO_MORE_WORK;\
                    return;\
                }\
            }\
        }\
